...
```lua
local Library = loadstring(game:HttpGet("https://raw.githubusercontent.com/YOURUSERNAME/EliteGlassUI/main/src/EliteGlassUI.lua"))()
```
...
Configs are saved to `EliteGlassUI_Configs/` folder (executor only).
...
├── src/
│   └── EliteGlassUI.lua
├── example.lua          # Full demo with all elements
├── README.md
├── LICENSE
└── .gitignore
```
...
- Line 12: `LOGO_ASSET` - change loader logo
- Line 13: Preload assets
- `Color3.fromRGB(0, 137, 123)` - change accent color (search & replace)
- Loader title: "E - Zero"
...
---
**EliteGlassUI v2 - Fluent style, made simple**
