                ...
                function TabObj:NewSection(sectionName)
                        ...
                        function SectionObj:NewSlider(sliderText, sliderInfo, min, max, default, callback)
                                ...
                                local function updateSlider(animate)
                                        ...
                                        local thumbPosition = math.max(9, math.min(percentage * trackWidth, trackWidth - 9))
                                        
                                        if animate then
                                                Tween(SliderFill, {Size = UDim2.new(percentage, 0, 1, 0)}, 0.1)
                                                Tween(SliderThumb, {Position = UDim2.new(0, thumbPosition - 9, 0.5, -9)}, 0.1)
                                        else
                                                SliderFill.Size = UDim2.new(percentage, 0, 1, 0)
                                                SliderThumb.Position = UDim2.new(0, thumbPosition - 9, 0.5, -9)
                                        end
...
return Library        local LoaderStroke = Instance.new("UIStroke")
        LoaderStroke.Color = Color3.fromRGB(255, 255, 255)
        LoaderStroke.Thickness = 1
        LoaderStroke.Transparency = 0.7
        LoaderStroke.Parent = LoaderFrame
                ...
                function TabObj:NewSection(sectionName)
                        ...
                        function SectionObj:NewSlider(sliderText, sliderInfo, min, max, default, callback)
                                ...
                                local function updateSlider(animate)
                                        local percentage = (value - min) / (max - min)
                                        local trackWidth = SliderTrack.AbsoluteSize.X
                                        local thumbPosition = math.max(8, math.min(percentage * trackWidth - 8, trackWidth - 8))
                                        
                                        if animate then
                                                Tween(SliderFill, {Size = UDim2.new(percentage, 0, 1, 0)}, 0.1)
                                                Tween(SliderThumb, {Position = UDim2.new(0, thumbPosition - 8, 0.5, -8)}, 0.1)
                                        else
                                                SliderFill.Size = UDim2.new(percentage, 0, 1, 0)
                                                SliderThumb.Position = UDim2.new(0, thumbPosition - 8, 0.5, -8)
                                        end
                                        ...
                                        -- Visual feedback
                                        if isDragging then
                                                Tween(ThumbOuter, {BackgroundTransparency = 0}, 0.1)
                                                Tween(OuterStroke, {Transparency = 0}, 0.1)
                                        elseif isHovering then
                                                Tween(ThumbOuter, {BackgroundTransparency = 0.05}, 0.1)
                                                Tween(OuterStroke, {Transparency = 0.2}, 0.1)
                                        else
                                                Tween(ThumbOuter, {BackgroundTransparency = 0.1}, 0.1)
                                                Tween(OuterStroke, {Transparency = 0.3}, 0.1)
                                        end
